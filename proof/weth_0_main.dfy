...
module main {
	...
	// Static stack items
	requires (st'.Peek(1) == 0x4 && st'.Peek(2) == 0x4 && st'.Peek(3) == 0x229)
	{
		var st := st';
		// |fp=0x0060|_,0x04,0x04,0x229,_|
		st := Swap(st,1);
	...
	// Static stack items
	requires (st'.Peek(1) == 0x24 && st'.Peek(2) == 0x4 && st'.Peek(4) == 0x229)
	{
		var st := st';
	...
	requires st'.Operands() == 6
	// Static stack items
	requires (st'.Peek(0) == 0x44 && st'.Peek(1) == 0x4 && st'.Peek(4) == 0x229)
	{
		var st := st';
	...
	// Static stack items
	requires (st'.Peek(0) == 0x64 && st'.Peek(1) == 0x4 && st'.Peek(5) == 0x229)
	{
		var st := st';
	...
	requires st'.Operands() == 6
	// Static stack items
	requires (st'.Peek(0) == 0x20 && st'.Peek(1) == 0x4 && st'.Peek(3) == 0x4 && st'.Peek(4) == 0x264)
	{
		var st := st';
	...
	// Static stack items
	requires (st'.Peek(0) == 0x000000000000000000000000ffffffffffffffffffffffffffffffffffffffff && st'.Peek(2) == 0x0 && st'.Peek(3) == 0x3 && st'.Peek(6) == 0x264)
	{
		var st := st';
		// |fp=0x0060|0xffffffffffffffffffffffffffffffffffffffff,_,0x00,0x03,_,_,0x264,_|
		st := And(st);
	...
	// Static stack items
	requires (st'.Peek(0) == 0x60 && st'.Peek(1) == 0x60 && st'.Peek(2) == 0x0 && st'.Peek(3) == 0x60 && st'.Peek(8) == 0x264)
	{
		var st := st';
	...
	requires st'.Operands() == 8
	// Static stack items
	requires (st'.Peek(1) == 0x60 && st'.Peek(6) == 0x264)
	{
		var st := st';
		// |fp=0x0060|_,0x60,_,_,_,_,0x264,_|
		st := Pop(st);
	...
	requires st'.Operands() == 7
	// Static stack items
	requires (st'.Peek(0) == 0x60 && st'.Peek(2) == 0x7fcf532c15f0a6db0bd6d0e038bea71d30d808c7d98cb3bf7268a95bf5081b65 && st'.Peek(5) == 0x264)
	{
		var st := st';
	...
	requires st'.Operands() == 7
	// Static stack items
	requires (st'.Peek(0) == 0x60 && st'.Peek(1) == 0x80 && st'.Peek(2) == 0x7fcf532c15f0a6db0bd6d0e038bea71d30d808c7d98cb3bf7268a95bf5081b65 && st'.Peek(5) == 0x264)
	{
		var st := st';
