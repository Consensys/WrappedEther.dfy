...
module symbol {
	...
	method block_0_0x02e2(callSig: u256, st': EvmState.ExecutingState) returns (st'': EvmState.State)
	...
	method block_0_0x02ed(callSig: u256, st': EvmState.ExecutingState) returns (st'': EvmState.State)
	requires st'.evm.code == Code.Create(BYTECODE_0)
  	...
  	requires st'.Load(0x01) == 0x5745544800000000000000000000000000000000000000000000000000000008 // "WETH" ... 0s ... len*2  
	{
		...
		//|fp=0x0060|0x2f5,symbol|
		stackLemma(st,st.Operands());
		st := block_0_0x0b30(callSig,st);
		return st;
	}

	method block_0_0x02f5(callSig: u256, st': EvmState.ExecutingState) returns (st'': EvmState.State)
	requires st'.evm.code == Code.Create(BYTECODE_0)
	...
	requires 0x95d89b41 == callSig
	// Static stack items
	requires st'.evm.stack.contents == [0x60,0x2f5,callSig]
	{
		var st := st';
		stackLemma(st,st.Operands());
		...
		stackLemma(st,st.Operands());
		st := block_0_0x02ff(callSig,st);  
		return st;
	}

	method block_0_0x02ff(callSig: u256, st': EvmState.ExecutingState) returns (st'': EvmState.State)
	requires st'.evm.code == Code.Create(BYTECODE_0)
	...
	requires 0x95d89b41 == callSig
	// Static stack items
	requires st'.evm.stack.contents == [0xa0,0xc0,0xa0,0xa0,0x60,0x2f5,callSig]
	{
		var st := st';
		stackLemma(st,st.Operands());
		// ||0xa0,0xc0,0xa0,0xa0,*ptr(len),0x2f5,symbol| 
		...
		stackLemma(st,st.Operands());
		st := block_0_0x0302(callSig,st);
		return st;
	}

	method block_0_0x0302(callSig: u256, st': EvmState.ExecutingState) returns (st'': EvmState.State)
	requires st'.evm.code == Code.Create(BYTECODE_0)
	...
	requires st'.Read(0x60) == 0x04  && st'.Read(0x80) == 0x5745544800000000000000000000000000000000000000000000000000000000
	// Static stack items
	requires st'.evm.stack.contents == [0xa0,0x20,0xc0,0xa0,0xa0,0x60,0x2f5,callSig]
	{
		var st := st';
		stackLemma(st,st.Operands());	
		st := MStore(st);   
		...
		stackLemma(st,st.Operands());
		st := block_0_0x0303(callSig,st);
		return st;
	}
		
	method block_0_0x0303(callSig: u256, st': EvmState.ExecutingState) returns (st'': EvmState.State)
	requires st'.evm.code == Code.Create(BYTECODE_0)
	...
	requires st'.Read(0x60) == 0x04  && st'.Read(0x80) == 0x5745544800000000000000000000000000000000000000000000000000000000
	// Static stack items
	requires st'.evm.stack.contents == [0xc0,0xa0,0xa0,0x60,0x2f5,callSig]
	{
		var st := st';
		stackLemma(st,st.Operands());	
		st := Dup(st,4);
		...
		stackLemma(st,st.Operands());
		st := block_0_0x0307(callSig,st);
		return st;
	}

	method block_0_0x0307(callSig: u256, st': EvmState.ExecutingState) returns (st'': EvmState.State)
	requires st'.evm.code == Code.Create(BYTECODE_0)
	...
	requires st'.Read(0x60) == 0x04  && st'.Read(0x80) == 0x5745544800000000000000000000000000000000000000000000000000000000
	// Static stack items
	requires st'.evm.stack.contents == [st'.Read(0x60),0xc0,0x60,0xc0,0xa0,0xa0,0x60,0x2f5,callSig]
	{
		var st := st';
		stackLemma(st,st.Operands());
		// ||len,0xc0,*ptr(len),0xc0,0xa0,0xa0,*ptr(len),0x2f5,symbol| 
		...
		stackLemma(st,st.Operands());
		st := block_0_0x030b(callSig,st);
		return st;
	}

	method block_0_0x030b(callSig: u256, st': EvmState.ExecutingState) returns (st'': EvmState.State)
	requires st'.evm.code == Code.Create(BYTECODE_0)
	...
	requires st'.Read(0x60) == 0x04  && st'.Read(0x80) == 0x5745544800000000000000000000000000000000000000000000000000000000
	// Static stack items
	requires st'.evm.stack.contents == [0x20,0xc0,0x60,0xc0,0xa0,0xa0,0x60,0x2f5,callSig]
	{
		var st := st';
		stackLemma(st,st.Operands());
		// ||0x20,0xc0,*ptr(len),0xc0,0xa0,0xa0,*ptr(len),0x2f5,symbol|
		...
		stackLemma(st,st.Operands());
		st := block_0_0x0310(callSig,st);
		return st;
	}

	method block_0_0x0310(callSig: u256, st': EvmState.ExecutingState) returns (st'': EvmState.State)
	requires st'.evm.code == Code.Create(BYTECODE_0)
	...
	requires st'.Read(0x60) == 0x04  && st'.Read(0x80) == 0x5745544800000000000000000000000000000000000000000000000000000000
	// Static stack items
	requires st'.evm.stack.contents == [0x04,0x60,0xe0,0xa0,0xa0,0x60,0x2f5,callSig]
	{
		var st := st';
		stackLemma(st,st.Operands());
		// ||len,*ptr(len),0xe0,0xa0,0xa0,*ptr(len),0x2f5,symbol|
		...
		stackLemma(st,st.Operands());
		st := block_0_0x031a(0,callSig,st); 
		return st;
	}
	...
	method block_0_0x031a(i: u256, callSig: u256, st': EvmState.ExecutingState) returns (st'': EvmState.State)
	requires st'.evm.code == Code.Create(BYTECODE_0)
	...
	requires st'.evm.stack.contents == [st'.Peek(0),0x80,0xe0,0x04,0x04,0x80,0xe0,0xa0,0xa0,0x60,0x2f5,callSig]
	// Termination
	decreases (st'.Read(0x60)+0x1f) - i*0x20,2
	{
		...
		stackLemma(st,st.Operands());
		st := block_0_0x0324(i,callSig,st);
		return st;
	}

	method block_0_0x0324(i: u256, callSig: u256, st': EvmState.ExecutingState) returns (st'': EvmState.State)
	requires st'.evm.code == Code.Create(BYTECODE_0)
	...
	requires 0x95d89b41 == callSig
	// Static stack items
	requires st'.evm.stack.contents == [0x0,0x0,0x80,0xe0,0x04,0x04,0x80,0xe0,0xa0,0xa0,0x60,0x2f5,callSig]
	requires i == 0
	decreases 0x04 - i,4
	{
		var st := st';
		...
		stackLemma(st,st.Operands());
		st := block_0_0x0326(i,callSig,st);
		return st;
	}
	
	method block_0_0x0326(i: u256, callSig: u256, st': EvmState.ExecutingState) returns (st'': EvmState.State)
	requires st'.evm.code == Code.Create(BYTECODE_0)
	...
	requires 0x95d89b41 == callSig
	// Static stack items
	requires st'.evm.stack.contents == [0x80,0x0,0x80,0xe0,0x04,0x04,0x80,0xe0,0xa0,0xa0,0x60,0x2f5,callSig]
	// Storage
	requires i == 0
	decreases 0x04 - i,3
	{
		...
		// |0xe0+i,st.Read(0x80+(i*0x20)),i*0x20,0x80,0xe0,len,len,0x80,0xe0,0xa0,0xa0,*ptr(len),0x2f5,symbol|
		stackLemma(st,st.Operands());
		st := block_0_0x032a(i,callSig,st);
		return st;
	}

	method block_0_0x032a(i: u256, callSig: u256, st': EvmState.ExecutingState) returns (st'': EvmState.State)
	requires st'.evm.code == Code.Create(BYTECODE_0)
	...
	// Static stack items
	requires i == 0
	requires st'.evm.stack.contents == [0xe0,st'.Read(0x80),0x0,0x80,0xe0,0x04,0x04,0x80,0xe0,0xa0,0xa0,0x60,0x2f5,callSig]
	// Storage
	decreases 0x04 - i,2
	{
		var st := st';
		...
		st := MStore(st);
		stackLemma(st,st.Operands());
		st := block_0_0x032b(i,callSig,st);
		return st;
	}

	method block_0_0x032b(i: u256, callSig: u256, st': EvmState.ExecutingState) returns (st'': EvmState.State)
	requires st'.evm.code == Code.Create(BYTECODE_0)
	...
	// Static stack items
	requires i == 0
	requires st'.evm.stack.contents == [0x0,0x80,0xe0,0x04,0x04,0x80,0xe0,0xa0,0xa0,0x60,0x2f5,callSig]
	// Storage
	decreases 0x04 - i,1
	{
		var st := st';
		...
		// |(i*0x20)+0x20,0x80,0xe0,len,len,0x80,0xe0,0xa0,0xa0,*ptr(len),0x2f5,symboll|
		stackLemma(st,st.Operands());
		st := block_0_0x031a(i+1,callSig,st);
		return st;
	}

	// from 031a ... i.e. i'+0x20<len and i' == 0
	// |i'+0x20,0x80,0xe0,len,len,0x80,0xe0,0xa0,0xa0,*ptr(len),0x2f5,symbol|
	method block_0_0x0335(callSig: u256, st': EvmState.ExecutingState) returns (st'': EvmState.State)
	requires st'.evm.code == Code.Create(BYTECODE_0)
	...
	requires 0x95d89b41 == callSig
	// Static stack items
	requires st'.evm.stack.contents == [st'.Peek(0),st'.Peek(1),st'.Peek(2),st'.Peek(3),0x04,0x80,0xe0,0xa0,0xa0,0x60,0x2f5,callSig]
	{
		var st := st';
		stackLemma(st,st.Operands());
		...
		stackLemma(st,st.Operands());
		st := block_0_0x033d(callSig,st);
		return st;
	}

	method block_0_0x033d(callSig: u256, st': EvmState.ExecutingState) returns (st'': EvmState.State)
	requires st'.evm.code == Code.Create(BYTECODE_0)
	...
	requires 0x95d89b41 == callSig
	// Static stack items
	requires st'.evm.stack.contents == [0xe0,0x04,0xa0,0xa0,0x60,0x2f5,callSig]
	{
		var st := st';
		stackLemma(st,st.Operands());
		// |0xe0,len,0xa0,0xa0,*ptr(len),0x2f5,symbol|
		...
		stackLemma(st,st.Operands());
		st := block_0_0x0348(callSig,st);
		return st;
	}

	method block_0_0x0348(callSig: u256, st': EvmState.ExecutingState) returns (st'': EvmState.State)
	requires st'.evm.code == Code.Create(BYTECODE_0)
	...
	requires 0x95d89b41 == callSig
	// Static stack items
	requires st'.evm.stack.contents == [0x362,0x0,0x04,0xe4,0xa0,0xa0,0x60,0x2f5,callSig]
	{
		var st := st';
		stackLemma(st,st.Operands());
		//||0x0362,0,len,0xe4,0xa0,0xa0,*ptr(len),0x2f5,symbol|
		...
		stackLemma(st,st.Operands());
		st := block_0_0x0351(callSig,st);
		return st;
	}

	method block_0_0x0351(callSig: u256, st': EvmState.ExecutingState) returns (st'': EvmState.State)
	requires st'.evm.code == Code.Create(BYTECODE_0)
	...
	requires 0x95d89b41 == callSig
	// Static stack items
	requires st'.evm.stack.contents == [0x04,0x1,st'.Read(0xe0),0xe0,st'.Peek(4),st'.Peek(5),0xa0,0xa0,0x60,0x2f5,callSig]
	{
		var st := st';
		stackLemma(st,st.Operands());
		//||len,0x01,Read(0xe0),0xe0,len,0xe4,0xa0,0xa0,*ptr(len),0x2f5,symbol|
		...
		stackLemma(st,st.Operands());
		st := block_0_0x0357(callSig,st);
		return st;
	}

	method block_0_0x0357(callSig: u256, st': EvmState.ExecutingState) returns (st'': EvmState.State)
	requires st'.evm.code == Code.Create(BYTECODE_0)
	requires st'.WritesPermitted() && st'.PC() == 0x0357
	// Free memory pointer
	requires st'.MemSize() >= 0x100 && st'.Read(0x40) == 0xa0 
									&& st'.Read(0x60) == 0x04 
									//&& st'.Read(0x80) == 0x5745544800000000000000000000000000000000000000000000000000000000 
	...
	requires 0x95d89b41 == callSig
	// Static stack items
	requires st'.evm.stack.contents == [0x100,0x1c,0x1,st'.Read(0xe0),0xe0,st'.Peek(5),st'.Peek(6),0xa0,0xa0,0x60,0x2f5,callSig]
	{
		var st := st';
		stackLemma(st,st.Operands());
		//||0x100,0x1c,0x01,Read(0xe0),0xe0,len,0xe4,0xa0,0xa0,*ptr(len),0x2f5,symbol|
		...
		stackLemma(st,st.Operands());
		st := block_0_0x0358(callSig,st);
		return st;
	}
	
	method block_0_0x0358(callSig: u256, st': EvmState.ExecutingState) returns (st'': EvmState.State)
	requires st'.evm.code == Code.Create(BYTECODE_0)
	...
	requires 0x95d89b41 == callSig
	// Static stack items
	requires st'.evm.stack.contents == [0x100000000000000000000000000000000000000000000000000000000,0x1,st'.Read(0xe0),0xe0,st'.Peek(4),st'.Peek(5),0xa0,0xa0,0x60,0x2f5,callSig]
	{
		var st := st';
		stackLemma(st,st.Operands());
		//||(2^224),0x01,Read(0xe0),0xe0,len,0xe4,0xa0,0xa0,*ptr(len),0x2f5,symbol|
		...
		st := Not(st);
		stackLemma(st,st.Operands());
		st := block_0_0x035a(callSig,st);
		return st;
	}
		
	method block_0_0x035a(callSig: u256, st': EvmState.ExecutingState) returns (st'': EvmState.State)
	requires st'.evm.code == Code.Create(BYTECODE_0)
	...
	requires 0x95d89b41 == callSig
	// Static stack items
	requires st'.evm.stack.contents == [0xffffffff00000000000000000000000000000000000000000000000000000000,st'.Read(0xe0),0xe0,st'.Peek(3),st'.Peek(4),0xa0,0xa0,0x60,0x2f5,callSig]
	{
		var st := st';	
		stackLemma(st,st.Operands());
		...
		stackLemma(st,st.Operands());
		st := block_0_0x035b(callSig,st);
		return st;
	}

	method block_0_0x035b(callSig: u256, st': EvmState.ExecutingState) returns (st'': EvmState.State)
	requires st'.evm.code == Code.Create(BYTECODE_0)
	...
	requires 0x95d89b41 == callSig
	// Static stack items
	requires st'.evm.stack.contents == [0x5745544800000000000000000000000000000000000000000000000000000000,0xe0,st'.Peek(2),st'.Peek(3),0xa0,0xa0,0x60,0x2f5,callSig]
	{
		var st := st';
		stackLemma(st,st.Operands());
		...
		stackLemma(st,st.Operands());
		st := block_0_0x035d(callSig,st);
		return st;
	}
		
	method block_0_0x035d(callSig: u256, st': EvmState.ExecutingState) returns (st'': EvmState.State)
	requires st'.evm.code == Code.Create(BYTECODE_0)
	...
	requires 0x95d89b41 == callSig
	// Static stack items
	requires st'.evm.stack.contents == [0xe0,st'.Peek(1),st'.Peek(2),0xa0,0xa0,0x60,0x2f5,callSig]
	{
		var st := st';	
		stackLemma(st,st.Operands());
		//||0xe0,len,0xe4,0xa0,0xa0,*ptr(len),0x2f5,symbol| 
	...
	method block_0_0x0362(callSig: u256, st': EvmState.ExecutingState) returns (st'': EvmState.State)
	requires st'.evm.code == Code.Create(BYTECODE_0)
	...
	requires 0x95d89b41 == callSig
	// Static stack items
	requires st'.evm.stack.contents == [st'.Peek(0),0x100,0xa0,0xa0,0x60,0x2f5,callSig]
	{
		var st := st';
		stackLemma(st,st.Operands());
		//||len,0x100,0xa0,0xa0,*ptr(len),0x2f5,symbol|
		...
		//||0xa0,0x100,0x2f5,symbol|
		stackLemma(st,st.Operands());
		st := block_0_0x036b(callSig,st);
		return st;
	}

	method block_0_0x036b(callSig: u256, st': EvmState.ExecutingState) returns (st'': EvmState.State)
	requires st'.evm.code == Code.Create(BYTECODE_0)
	...
	requires 0x95d89b41 == callSig
	// Static stack items
	requires st'.evm.stack.contents == [0xa0,0x100,0x2f5,callSig]
	...
	method block_0_0x0b30(callSig: u256, st': EvmState.ExecutingState) returns (st'': EvmState.State)
	requires st'.evm.code == Code.Create(BYTECODE_0)
	...
	requires 0x95d89b41 == callSig
	// Static stack items
	requires st'.evm.stack.contents == [0x2f5,callSig]
	// Storage
  	requires st'.Load(0x01) == 0x5745544800000000000000000000000000000000000000000000000000000008 // "WETH" ... 0s ... len*2  
	{
		var st := st';
		...
		stackLemma(st,st.Operands());
		st := block_0_0x0b3b(callSig,st);
		return st;
	}

	method block_0_0x0b3b(callSig: u256, st': EvmState.ExecutingState) returns (st'': EvmState.State)
	requires st'.evm.code == Code.Create(BYTECODE_0)
	...
	requires 0x95d89b41 == callSig
	// Static stack items
	requires st'.evm.stack.contents == [0x0,0x01,st'.Load(0x01),0x01,0x2f5,callSig]
	// Storage
  	requires st'.Load(0x01) == 0x5745544800000000000000000000000000000000000000000000000000000008 // "WETH" ... 0s ... len*2  
	{
		var st := st';
		...
		st := block_0_0x0b46(callSig,st);
		return st;
	}

	method block_0_0x0b46(callSig: u256, st': EvmState.ExecutingState) returns (st'': EvmState.State)
	requires st'.evm.code == Code.Create(BYTECODE_0)
	...
	requires 0x95d89b41 == callSig
	// Static stack items
	requires st'.evm.stack.contents == [0x04,0x01,0x2f5,callSig]
	// Storage
  	requires st'.Load(0x01) == 0x5745544800000000000000000000000000000000000000000000000000000008 // "WETH" ... 0s ... len*2  
	{
		var st := st';
		...
		stackLemma(st,st.Operands());
		st := block_0_0x0b50(callSig,st);
		return st;
	}

	method block_0_0x0b50(callSig: u256, st': EvmState.ExecutingState) returns (st'': EvmState.State)
	requires st'.evm.code == Code.Create(BYTECODE_0)
	...
	requires 0x95d89b41 == callSig
	// Static stack items
	requires st'.evm.stack.contents == [0x20,0x04,0x01,0x2f5,callSig]
	// Storage
  	requires st'.Load(0x01) == 0x5745544800000000000000000000000000000000000000000000000000000008 // "WETH" ... 0s ... len*2  
	{
		var st := st';
		...
		stackLemma(st,st.Operands());
		st := block_0_0x0b5b(callSig,st);
		return st;
	}

	method block_0_0x0b5b(callSig: u256, st': EvmState.ExecutingState) returns (st'': EvmState.State)
	requires st'.evm.code == Code.Create(BYTECODE_0)
	...
	requires 0x95d89b41 == callSig
	// Static stack items
	requires st'.evm.stack.contents == [0x40,0xa0,0x60,0x04,0x01,0x2f5,callSig]
	// Storage
	requires st'.Load(0x01) == 0x5745544800000000000000000000000000000000000000000000000000000008 // "WETH" ... 0s ... len*2  
  	{
		var st := st';
		...
		stackLemma(st,st.Operands());
		st := block_0_0x0b62(callSig,st);
		return st;
	}
		
	method block_0_0x0b62(callSig: u256, st': EvmState.ExecutingState) returns (st'': EvmState.State)
	requires st'.evm.code == Code.Create(BYTECODE_0)
	requires st'.WritesPermitted() && st'.PC() == 0x0b62
	// Free memory pointer
	...
	requires 0x95d89b41 == callSig
	// Static stack items
	requires st'.evm.stack.contents == [0x60,0x04,0x60,0x04,0x01,0x60,0x2f5,callSig]
	// Storage
	requires st'.Load(0x01) == 0x5745544800000000000000000000000000000000000000000000000000000008 // "WETH" ... 0s ... len*2  
	{
		var st := st';
		...
		stackLemma(st,st.Operands());
		st := block_0_0x0b63(callSig,st);
		return st;
	}

	method block_0_0x0b63(callSig: u256, st': EvmState.ExecutingState) returns (st'': EvmState.State)
	requires st'.evm.code == Code.Create(BYTECODE_0)
	...
	requires 0x95d89b41 == callSig
	// Static stack items
	requires st'.evm.stack.contents == [0x60,0x04,0x01,0x60,0x2f5,callSig]
	// Storage
	requires st'.Load(0x01) == 0x5745544800000000000000000000000000000000000000000000000000000008 // "WETH" ... 0s ... len*2  
	{
		var st := st';
		...
		stackLemma(st,st.Operands());
		st := block_0_0x0b6e(callSig,st);
		return st;
	}

	method block_0_0x0b6e(callSig: u256, st': EvmState.ExecutingState) returns (st'': EvmState.State)
	requires st'.evm.code == Code.Create(BYTECODE_0)
	...
	requires 0x95d89b41 == callSig
	// Static stack items
	requires st'.evm.stack.contents == [0x01,st'.Load(0x1),0x01,st'.Load(0x1),0x01,0x80,0x04,0x01,0x60,0x2f5,callSig]
	// Storage
	requires st'.Load(0x01) == 0x5745544800000000000000000000000000000000000000000000000000000008 // "WETH" ... 0s ... len*2  
	{
		var st := st';
		...
		stackLemma(st,st.Operands());
		st := block_0_0x0b79(callSig,st);
		return st;
	}

	method block_0_0x0b79(callSig: u256, st': EvmState.ExecutingState) returns (st'': EvmState.State)
	requires st'.evm.code == Code.Create(BYTECODE_0)
	...
	requires 0x95d89b41 == callSig
	// Static stack items
	requires st'.evm.stack.contents == [0x08,0x02,0x01,0x80,0x04,0x01,0x60,0x2f5,callSig]
	// Storage
	requires st'.Load(0x01) == 0x5745544800000000000000000000000000000000000000000000000000000008 // "WETH" ... 0s ... len*2  
	{
		var st := st';
		...
		stackLemma(st,st.Operands());
		st := block_0_0x0b84(callSig,st);
		return st;
	}

	method block_0_0x0b84(callSig: u256, st': EvmState.ExecutingState) returns (st'': EvmState.State)
	requires st'.evm.code == Code.Create(BYTECODE_0)
	...
	requires 0x95d89b41 == callSig
	// Static stack items
	requires st'.evm.stack.contents == [0x0,0x04,0x01,0x80,0x04,0x01,0x60,0x2f5,callSig]
	// Storage
 	requires st'.Load(0x01) == 0x5745544800000000000000000000000000000000000000000000000000000008 // "WETH" ... 0s ... len*2  
	{
		var st := st';
		...
		stackLemma(st,st.Operands());
		st := block_0_0x0b90(callSig,st);
		return st;
	}

	method block_0_0x0b90(callSig: u256, st': EvmState.ExecutingState) returns (st'': EvmState.State)
	requires st'.evm.code == Code.Create(BYTECODE_0)
	...
	requires 0x95d89b41 == callSig
	// Static stack items
	requires st'.evm.stack.contents == [0x5745544800000000000000000000000000000000000000000000000000000000,0x04,0x01,0x80,0x04,0x01,0x60,0x2f5,callSig]
	// Storage
	requires st'.Load(0x01) == 0x5745544800000000000000000000000000000000000000000000000000000008 // "WETH" ... 0s ... len*2  
	{
		var st := st';
	...
	// method block_0_0x0b9b(callSig: u256, st': EvmState.ExecutingState) returns (st'': EvmState.State)
	// requires st'.evm.code == Code.Create(BYTECODE_0)
	...
	// method block_0_0x0ba5(n: u256, callSig: u256, st': EvmState.ExecutingState) returns (st'': EvmState.State)
	// requires st'.evm.code == Code.Create(BYTECODE_0)
	...
	// method block_0_0x0ba9(i: u256, n: u256, callSig: u256, st': EvmState.ExecutingState) returns (st'': EvmState.State)
	// requires st'.evm.code == Code.Create(BYTECODE_0)
	...
	// method block_0_0x0bb2(i: u256, n: u256, callSig: u256, st': EvmState.ExecutingState) returns (st'': EvmState.State)
	// requires st'.evm.code == Code.Create(BYTECODE_0)
	...
	// method block_0_0x0bb9(i: u256, n: u256, callSig: u256, st': EvmState.ExecutingState) returns (st'': EvmState.State)
	// requires st'.evm.code == Code.Create(BYTECODE_0)
	...
	// method block_0_0x0bc4(callSig: u256, st': EvmState.ExecutingState) returns (st'': EvmState.State)
	// requires st'.evm.code == Code.Create(BYTECODE_0)
	...
	method block_0_0x0bc6(callSig: u256, st': EvmState.ExecutingState) returns (st'': EvmState.State)
	requires st'.evm.code == Code.Create(BYTECODE_0)
	...
	requires 0x95d89b41 == callSig
	// Static stack items
	requires st'.evm.stack.contents == [st'.Peek(0),st'.Peek(1),st'.Peek(2),st'.Peek(3),st'.Peek(4),0x60,0x2f5,callSig]
	{
		var st := st';
		stackLemma(st,st.Operands());
		// ||len,0x01,0xa0,len,0x01,*ptr(len),0x2f5,symbol|
